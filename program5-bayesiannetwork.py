...
cpd_burglary = pgmpy.factors.discrete.TabularCPD(
    'Burglary', 2, [[0.001], [0.999]])
# Probability of earthquake (True, False)
cpd_earthquake = pgmpy.factors.discrete.TabularCPD(
    'Earthquake', 2, [[0.002], [0.998]])
...
posterior_probability = infer.query(
    ['Burglary'], evidence={'JohnCalls': 0, 'MaryCalls': 0})
...
posterior_probability = infer.query(
    ['Alarm'], evidence={'Burglary': 0, 'Earthquake': 0})
# Print posterior probability
